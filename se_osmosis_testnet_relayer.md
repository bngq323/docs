...
Transfer uosmo from Osmosis to Namada's payment address which belongs to "my-spending-key" 
```
namadac balance --owner se_wallet --node "144.76.65.89:26657"
naan: 1500.207602
transfer/channel-120/uosmo: 2000000
namadanet@vmi1662412:~$ osmosisd tx ibc-transfer transfer \
  transfer \
  channel-5624 \
  znam1qq5fdnjkhv7trs0rkhfspn2ddx5e2czcqxgm07dqh5j637qjghv00rast9kljjd6nt3m3ts5m2qx2 \
  1000000uosmo \
  --from osmo_wallet \
  --gas auto \
  --gas-prices 0.035uosmo \
...
timestamp: ""
tx: null
txhash: C6795E9810202016A85C5194EB6D92390F4DFF7826ECFB162BCB7BA22FF77FBC
```
Check "my-spending-key" balance.
```
namadac balance --owner my-spending-key --node "144.76.65.89:26657"
```
